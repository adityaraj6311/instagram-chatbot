...
const god = "@aditya.agatsuma"; //Your Instagram ID
...
client.on('messageCreate', (message) => {
    ...
    chatbot(`http://api.brainshop.ai/get?bid=169976&key=vroVmiAsTNWUy5rZ&uid=[uid]&msg=${encodeURIComponent(message.content)}`)
...
client.login('kurumi_chatbot', '1000tofu');  //Robot's Account Username and Password
